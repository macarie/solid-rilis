	...
	<div class="flex gap-7">
		...
		>
			<img
				...
				}" by ${properties.release.artists.map(({ name }) => name).join(", ")}`}
				class="rounded-lg"
			/>
			<div
				style={{
					"background-image": `url('${properties.release.images.at(0)!.url}')`,
				}}
		...
		<div class="flex min-w-0 flex-col gap-1">
			...
			<div class="mt-auto flex gap-2">
				<Tag>
					{relativeTime.format(
						getDaysPassedSince(properties.release.release_date),
						"days",
					)}
				</Tag>
